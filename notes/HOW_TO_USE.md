...
## What it covers
- Native Postgres, migrations `0001`–`0017`, and starting one backend instance
...
- Production post-push checks for Actions, systemd, Nginx/Socket.IO, SRS, migrations through `0017`, distinct Google OAuth callbacks, clip configuration, and a real phone stream
