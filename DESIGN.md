...
- The live scorecard overlay (Canvas, rendered above the video player) is the signature visual element of this product — it's what a viewer looks at most. Give it deliberate, considered styling; everything else in the UI (nav, points table, fixtures) should stay quieter by comparison.
